...
public class Box2dSteeringEntity extends Tank implements Steerable<Vector2> {
    //public class Box2dSteeringEntity extends Actor implements Steerable<Vector2> {
...
//        wrapAround(Level.pixelsToMeters(Tds.V_WIDTH), Level.pixelsToMeters(Tds.V_HEIGHT));
    ...
    public Box2dSteeringEntity(Level level, Vector2 position, TextureRegion textureHull,
